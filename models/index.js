...
Enquete.belongsTo(User, { foreignKey: "user_id", as: "user" });
Enquete.belongsTo(Message, { foreignKey: "mensagem_id", as: "mensagem" });
...
module.exports = { User, Service, Category, Like, Enquete, News, Comment, Storie, StorieView, Message };