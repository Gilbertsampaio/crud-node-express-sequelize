...
export default function ArrowIcon({ size = 24, color = "currentColor", direction = "right" }) {
    // Gira horizontalmente se a direção for "left"
    const rotation = direction === "right" ? "rotate(180 12 12)" : undefined;
