...
export default function ArchiveRefreshedIcon({ size = 24, color = "currentColor", direction = "down" }) {
    return (
        <svg
            viewBox="0 0 24 24"
            height={size}
        ...
        >
            ...
            <path
                ...
                fill={color}
                transform={direction === "up" ? "rotate(180 12 14)" : undefined}
            />
        </svg>
    );
}
